                        ...
                        <div class="table-title">
                            ...
                            <table class="table align-items-center table-flush" id="dataTable">
                                ...
                                <tbody>
                                    <?php
                     include("./config/conndb.php");   
                     $sql = "SELECT * FROM `user`  where `role` = N'2'";
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-warning mb-1" data-toggle="modal"
                                                data-target=".bd-example-modal-lg">Chọn Đơn Hàng</button>
                                        </td>
                                    </tr>
                                    <?php } ?>
                                </tbody>
        ...
        <div class="modal-content">
            <table class="table table-bordered">
                ...
                <tbody>
                    <?php
                  include("./config/conndb.php"); 
                  $sql = "SELECT * FROM `donhang` INNER JOIN `user` ON `user`.`ma`=`donhang`.`makh` WHERE `donhang`.`trangthai` = N'0'";
                  $result = mysqli_query($conn, $sql);
                  $data = mysqli_fetch_all($result, MYSQLI_ASSOC);
                  foreach ($data as $r) {
                  ?>
                    <tr>
                        <form action="./updateXulidon.php" method="post">
                            ...
                            <td>
                                <a href="updateXulidon.php?madh=<?php echo $r['madh'] ?>" class="edit" title="Edit"><i
                                        class="btn btn-warning mb-1">Chọn đơn hàng</i></a>
                            </td>
