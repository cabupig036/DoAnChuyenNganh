      ...
      <li class="nav-item active">
        ...
        <div id="collapseForm" class="collapse" aria-labelledby="headingForm" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item active" href="./hoanhang_user.php">Hoàn hàng</a>
          </div>
        </div>
      </li>
            ...
            <div class="col-lg-12">
                <div class="card mb-4">
                  <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h6 class="m-0 font-weight-bold text-primary">Hoàn hàng</h6>
                  </div>
                  <div class="table-responsive p-3">
                    <table class="table align-items-center table-flush" id="dataTable">
                      ...
                      <tbody>
                      <?php                                           
                          $sql="SELECT * from donhang JOIN user ON donhang.makh=user.ma WHERE makh = '$ma' AND  trangthai='6' ";
                          $query = mysqli_query($conn,$sql);	
                          $row = array();
                          while($data = mysqli_fetch_assoc($query)){
                              $row[] = array($data['madh'],$data['tensp'],$data['tienthuho'],$data['tenNN'],$data['sdtNN'],$data['diachiNN'],$data['img'],$data['goicuoc'],$data['tuychon'],$data['ghichu']);
                          }
