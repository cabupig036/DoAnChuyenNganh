  ...
  <div id="wrapper">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <?php 
          //tính tổng tiền thu hộ đối với các đơn đã giao hàng thành công
          $selTienTH = mysqli_query($conn,"SELECT SUM(tienthuho) FROM `donhang` WHERE makh = '$ma' AND  trangthai='5' AND doisoat='0'");
          ...
          //tính tổng phi giao hàng của các đơn mà "Bên gửi trả phí"
          $selPhiGH =  mysqli_query($conn,"SELECT SUM(goicuoc) FROM `donhang` WHERE makh = '$ma' AND  trangthai='5' AND tuychon = 'Bên gửi trả phí'AND doisoat='0'");
          ...
          //tính tổng tiền ship mà bên nhận trả cho các đơn hoàn hàng về (vì là đơn hoàn nên người gửi phải trả khoản phí ship này)
          $selPhiGHHH =  mysqli_query($conn,"SELECT SUM(goicuoc) FROM `donhang` WHERE makh = '$ma' AND  trangthai='6' AND tuychon = 'Bên nhận trả phí'AND doisoat='0'");
          ...
          //tinh phi hoan hang==========================================================         
          //tiền phí hoàn hàng (các đơn hoàn hàng về người gửi phải chịu thêm 1 khoản phí hoàn bằng với phí ship đi của đơn hàng đó - có nghĩa là người gửi phải trả 2 lần tiền ship )
          $selPhiHH =  mysqli_query($conn,"SELECT SUM(goicuoc) FROM `donhang` WHERE makh = '$ma' AND  trangthai='6' AND doisoat='0'");
          ...
          //tính số dư = tổng tiền thu hộ - tổng phí giao hàng(bên gửi trả phí và các đơn hoàn) - tổng phí hoàn hàng - phí chuyển khoản
